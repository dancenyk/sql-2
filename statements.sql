...
-- Rellena cada rol con números asociados a la tabla de `roles`
...
UPDATE usuarios SET id_categoria = 2 WHERE id_usuario IN (2,10,20);
UPDATE usuarios SET id_categoria = 3 WHERE id_usuario IN (3,19);
UPDATE usuarios SET id_categoria = 4 WHERE id_usuario IN (6,18);
UPDATE usuarios SET id_categoria = 5 WHERE id_usuario IN (4,8);
UPDATE usuarios SET id_categoria = 6 WHERE id_usuario IN (16);
UPDATE usuarios SET id_categoria = 7 WHERE id_usuario IN (11,12);
UPDATE usuarios SET id_categoria = 8 WHERE id_usuario IN (14);
UPDATE usuarios SET id_categoria = 9 WHERE id_usuario IN (15);
UPDATE usuarios SET id_categoria = 10 WHERE id_usuario IN (7);
